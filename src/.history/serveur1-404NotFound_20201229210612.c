    ...
    while (1)
    {
        ...
        if (fork() == 0)
        {
            ...
            while (ack_obtenu != times)
            {
                ...
                {
                    t_ecart.tv_sec = t_finit.tv_sec - t_commence.tv_sec;
                    t_ecart.tv_usec = t_finit.tv_usec - t_commence.tv_usec;
                    if(t_ecart.tv_sec<0 || t_ecart.tv_usec < 0){
                        timeout = old_timeout;
                    }else{
